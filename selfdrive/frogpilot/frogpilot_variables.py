...
class FrogPilotVariables:
  ...
  def update(self, started):
    ...
    if customization_level == 0:
      ...
      toggle.virtual_torque_blending = bool(car_make == "tesla" and self.default_frogpilot_toggles.VirtualTorqueBlending)
      toggle.hybrid_tacc = bool(car_make == "tesla" and self.default_frogpilot_toggles.HybridTACC)
